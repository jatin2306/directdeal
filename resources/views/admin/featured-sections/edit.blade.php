        ...
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" id="title" name="title" value="{{ old('title', $section->title) }}" placeholder="e.g. Luxury Villas" required>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control {{ $errors->has('heading') ? 'is-invalid' : '' }}" id="heading" name="heading" value="{{ old('heading', $section->heading) }}" placeholder="e.g. Best Picks This Month">
                ...
                <div class="col-md-6">
                    ...
                    @php
                        $isActiveVal = old('is_active', $section->is_active);
                        $isActiveVal = ($isActiveVal === true || $isActiveVal === 1 || $isActiveVal === '1');
                    @endphp
                    <select class="form-select {{ $errors->has('is_active') ? 'is-invalid' : '' }}" id="is_active" name="is_active">
                        <option value="1" {{ $isActiveVal ? 'selected' : '' }}>Active (show on homepage)</option>
